  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative w-32 h-32 rounded-full overflow-hidden mb-4 shadow-lg border-2 border-primary/20 bg-black/90">
          <video
            ref={videoRef}
            autoPlay
            playsInline
        ...
        {/* Controls Panel */}
        <div className="bg-black/80 backdrop-blur-sm rounded-full px-6 py-3 flex items-center gap-4 shadow-lg">
