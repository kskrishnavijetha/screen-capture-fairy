    ...
    <div className="min-h-screen bg-[#1a1f2c] p-4">
      <div className="max-w-4xl mx-auto text-center space-y-8 pt-20">
        ...
        <p className="text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed">
          Easily capture your screen directly from your browser—no downloads or 
          installations required. Whether you're creating tutorials, recording meetings, 
          or sharing gameplay, our free screen recorder is fast, secure, and hassle-free. 
          Start recording in just one click!
        </p>
